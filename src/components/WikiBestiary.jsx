  ...
  return (
    <div className="doc-layout" style={{ maxWidth: '100%' }}>
      ...
      <section className="doc-section warlord-section" style={{ display: 'flex', gap: '2rem', alignItems: 'flex-start' }}>
        ...
        <img src="https://corsproxy.io/?https://static.wikia.nocookie.net/lenders-cataclysm/images/b/b3/Ignis.png" alt="Ignis" style={{ width: '180px', height: 'auto', objectFit: 'contain', filter: 'drop-shadow(0 0 10px rgba(255, 60, 0, 0.5))' }} />
      </section>
      ...
      <section className="doc-section warlord-section" style={{ display: 'flex', gap: '2rem', alignItems: 'flex-start' }}>
        ...
        <img src="https://corsproxy.io/?https://static.wikia.nocookie.net/lenders-cataclysm/images/2/23/Netherite_Monstrosity.png" alt="Netherite Monstrosity" style={{ width: '180px', height: 'auto', objectFit: 'contain', filter: 'drop-shadow(0 0 10px rgba(100, 100, 100, 0.8))' }} />
      </section>
      ...
      <section className="doc-section warlord-section" style={{ display: 'flex', gap: '2rem', alignItems: 'flex-start' }}>
        ...
        <img src="https://corsproxy.io/?https://static.wikia.nocookie.net/lenders-cataclysm/images/b/b9/The_Harbinger.png" alt="The Harbinger" style={{ width: '180px', height: 'auto', objectFit: 'contain', filter: 'drop-shadow(0 0 10px rgba(200, 0, 50, 0.6))' }} />
      </section>
        ...
        <div style={{ flex: 1 }}>
          ...
          <ul className="doc-list">
            ...
            <li><strong>Drops Lendários:</strong> 
              <button className="craft-btn" onClick={() => onOpenRecipe('void_core')} style={{marginLeft: '0.5rem'}}>Void Core</button>. (Núcleo usado para a Void Forge e itens gravitacionais).
            </li>
          </ul>
        </div>
        <img src="https://corsproxy.io/?https://static.wikia.nocookie.net/lenders-cataclysm/images/e/ec/Ender_Golem.png" alt="Ender Golem" style={{ width: '180px', height: 'auto', objectFit: 'contain', filter: 'drop-shadow(0 0 10px rgba(150, 0, 255, 0.5))' }} />
      </section>
      ...
      <section className="doc-section" style={{ display: 'flex', gap: '2rem', alignItems: 'flex-start' }}>
        ...
        <img src="https://corsproxy.io/?https://static.wikia.nocookie.net/mowziesmobs/images/6/6d/Ferrous_Wroughtnaut.png" alt="Ferrous Wroughtnaut" style={{ width: '180px', height: 'auto', objectFit: 'contain', filter: 'drop-shadow(0 0 10px rgba(255, 255, 255, 0.2))' }} />
      </section>
      ...
      <section className="doc-section" style={{ display: 'flex', gap: '2rem', alignItems: 'flex-start' }}>
        ...
        <img src="https://corsproxy.io/?https://static.wikia.nocookie.net/mowziesmobs/images/2/24/Frostmaw.png" alt="Frostmaw" style={{ width: '180px', height: 'auto', objectFit: 'contain', filter: 'drop-shadow(0 0 10px rgba(0, 200, 255, 0.5))' }} />
      </section>
